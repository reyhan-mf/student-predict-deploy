...
def app():
    ...
    with st.expander("Academic Details"):
        ...
        st.info("The qualification obtained by the student before enrolling in higher education.")
        admission_grade = st.number_input("Admission Grade", min_value=0.0, step=1.0)
        st.info("Admission is the process by which a person applies, and is approved, for entry to the University and to a university qualification.")
        
        father_qualification = st.selectbox("Father's Education", [
            "Can't read or write",
        ...
        mother_qualification = st.selectbox("Mother's Education", [
            "Can't read or write",
            "Can read without having a 4th year of schooling",
            "Basic Education 1st Cycle (4th/5th year) or Equiv.",
            "Basic Education 2nd Cycle (6th/7th/8th Year) or Equiv.",
